...
```
docker run -e 'ACCEPT_EULA=Y' -e 'MSSQL_SA_PASSWORD=D3v3l0p3rPassw0rd.' -e 'MSSQL_PID=StandardDeveloper' -p 1433:1433 --name sql2025 --hostname sql2025 -d mcr.microsoft.com/mssql/server:2025-latest
```
